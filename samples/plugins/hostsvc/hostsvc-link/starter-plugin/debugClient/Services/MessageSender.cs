...
public class MessageSender : BackgroundService
{
    ...
    public async Task UpdatePosition()
    {
        ...
        Microsoft.Azure.SpaceFx.MessageFormats.HostServices.Link.PositionUpdateRequest request = new()
        {
            RequestHeader = new()
            {
    ...
    public async Task PositionRequest()
    {
        ...
        Microsoft.Azure.SpaceFx.MessageFormats.HostServices.Link.PositionRequest request = new()
        {
            RequestHeader = new()
            {
                TrackingId = Guid.NewGuid().ToString()

...
public class MessageSender : BackgroundService
{
    ...
    public async Task UpdatePosition()
    {
        ...
        Microsoft.Azure.SpaceFx.MessageFormats.PlatformServices.Deployment.PositionUpdateRequest request = new()
        {
            RequestHeader = new()
            {
    ...
    public async Task PositionRequest()
    {
        ...
        Microsoft.Azure.SpaceFx.MessageFormats.PlatformServices.Deployment.PositionRequest request = new()
        {
            RequestHeader = new()
            {
                TrackingId = Guid.NewGuid().ToString()

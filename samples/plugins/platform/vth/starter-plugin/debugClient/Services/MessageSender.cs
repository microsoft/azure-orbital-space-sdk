...
public class MessageSender : BackgroundService
{
    ...
    public async Task UpdatePosition()
    {
        ...
        Microsoft.Azure.SpaceFx.MessageFormats.PlatformServices.VTH.PositionUpdateRequest request = new()
        {
            RequestHeader = new()
            {
    ...
    public async Task PositionRequest()
    {
        ...
        Microsoft.Azure.SpaceFx.MessageFormats.PlatformServices.VTH.PositionRequest request = new()
        {
            RequestHeader = new()
            {
                TrackingId = Guid.NewGuid().ToString()

...
public class MessageSender : BackgroundService
{
    ...
    public async Task UpdatePosition()
    {
        ...
        Microsoft.Azure.SpaceFx.MessageFormats.PlatformServices.MessageTranslationService.PositionUpdateRequest request = new()
        {
            RequestHeader = new()
            {
    ...
    public async Task PositionRequest()
    {
        ...
        Microsoft.Azure.SpaceFx.MessageFormats.PlatformServices.MessageTranslationService.PositionRequest request = new()
        {
            RequestHeader = new()
            {
                TrackingId = Guid.NewGuid().ToString()

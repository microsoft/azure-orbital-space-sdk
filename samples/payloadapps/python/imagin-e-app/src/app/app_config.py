...
class AppConfig:
    ...
    def __init__(self, file_path='/var/spacedev/xfer/app-imagin-e-starter/inbox/app-config.json'):
        """
        Initializes the AppConfig object by loading the configuration from a JSON file.

        Args:
            file_path (str, optional): Path to the configuration JSON file. Defaults to '/var/spacedev/xfer/app-imagin-e-starter/inbox/app-config.json'.
        """
